...
} TripUpdateStopTimeUpdateScheduleRelationship;
...
} VehiclePositionVehicleStopStatus;
...
} VehiclePositionCongestionLevel;
...
@interface FeedMessage : PBGeneratedMessage {
@private
  BOOL hasHeader_:1;
  FeedHeader* header;
...
@interface FeedMessageBuilder : PBGeneratedMessageBuilder {
@private
  FeedMessage* result;
}
...
@interface FeedHeader : PBExtendableMessage {
@private
...
@interface FeedEntity : PBGeneratedMessage {
@private
...
@interface FeedEntityBuilder : PBGeneratedMessageBuilder {
@private
  FeedEntity* result;
}
...
@interface TripUpdate : PBExtendableMessage {
@private
  BOOL hasTimestamp_:1;
  BOOL hasTrip_:1;
  BOOL hasVehicle_:1;
...
@interface TripUpdateStopTimeEvent : PBExtendableMessage {
@private
  BOOL hasTime_:1;
  BOOL hasDelay_:1;
...
@private
  TripUpdateStopTimeEvent* result;
}
...
@interface TripUpdateStopTimeUpdate : PBExtendableMessage {
@private
  BOOL hasStopId_:1;
  BOOL hasArrival_:1;
...
@private
  TripUpdateStopTimeUpdate* result;
}
...
@interface VehiclePosition : PBExtendableMessage {
@private
  BOOL hasTimestamp_:1;
  BOOL hasStopId_:1;
  BOOL hasTrip_:1;
...
@interface Alert : PBExtendableMessage {
@private
  BOOL hasUrl_:1;
...
@interface TimeRange : PBGeneratedMessage {
@private
  BOOL hasStart_:1;
  BOOL hasEnd_:1;
  UInt64 start;
...
@interface Position : PBExtendableMessage {
@private
  BOOL hasOdometer_:1;
  BOOL hasLatitude_:1;
...
@interface TripDescriptor : PBExtendableMessage {
@private
  BOOL hasTripId_:1;
  BOOL hasRouteId_:1;
...
@interface VehicleDescriptor : PBExtendableMessage {
@private
  BOOL hasId_:1;
  BOOL hasLabel_:1;
...
@interface EntitySelector : PBExtendableMessage {
@private
...
@interface TranslatedString : PBGeneratedMessage {
@private
...
@interface TranslatedStringTranslation : PBGeneratedMessage {
@private
  BOOL hasText_:1;
  BOOL hasLanguage_:1;
  NSString* text;
...
@interface TranslatedStringTranslationBuilder : PBGeneratedMessageBuilder {
@private
  TranslatedStringTranslation* result;
}
...
@interface TranslatedStringBuilder : PBGeneratedMessageBuilder {
@private
