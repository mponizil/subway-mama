...
@interface TripReplacementPeriod : PBGeneratedMessage {
@private
  BOOL hasRouteId_:1;
...
@interface NyctFeedHeader : PBGeneratedMessage {
@private
...
@interface NyctTripDescriptor : PBGeneratedMessage {
@private
...
@interface NyctStopTimeUpdate : PBGeneratedMessage {
@private
